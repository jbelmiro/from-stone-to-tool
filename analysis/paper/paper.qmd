...
kable(head(gravettian_general))
kable(head(proto_general))
kable(head(solutrean_general))
...
kable(head(gravettian_retouched))
kable(head(proto_retouch))
kable(head(solutrean_retouch))
