...
general_table <- phase_dataset |> 
  ...
  dplyr::mutate(RETOUCHEDPIECETYPOLOGY = case_when(
    RETOUCHEDPIECETYPOLOGY == "Retouched blade" | RETOUCHEDPIECETYPOLOGY == "Retouched bladelet" | RETOUCHEDPIECETYPOLOGY == "Retouched bladelet fragment" | RETOUCHEDPIECETYPOLOGY == "Retouched flake" | RETOUCHEDPIECETYPOLOGY == "Retouched flake fragment" | RETOUCHEDPIECETYPOLOGY == "Retouched burin spall" ~ "Retouched blank",
    RETOUCHEDPIECETYPOLOGY == "Splintered piece fragment" ~ "Splintered piece",
    RETOUCHEDPIECETYPOLOGY == "Backed bladelet" | RETOUCHEDPIECETYPOLOGY == "Backed flake" ~ "Backed tool",
    RETOUCHEDPIECETYPOLOGY == "Retouched burin" ~ "Burin",
    TRUE ~ RETOUCHEDPIECETYPOLOGY))
...
wilcox_t_shelter <- solutrean_dataset |> 
  dplyr::mutate(Prov = case_when(
    RMTYPE == "TYPE 1" | RMTYPE == "TYPE 2" | RMTYPE == "TYPE 3" | RMTYPE == "TYPE 4" | RMTYPE == "TYPE 5" ~ "Local",
    RMTYPE == "TYPE 6" | RMTYPE == "TYPE 7" | RMTYPE == "TYPE 8" | RMTYPE == "TYPE 9" | RMTYPE == "TYPE 11" ~ "Non-local",
    TRUE ~ RMTYPE)) |> 
   mutate(CLASS = case_when(
    CLASS == "Flake" | CLASS == "ElongBlank" | CLASS == "Thinning flake" ~ "Blank",
    TRUE ~ CLASS)) |>
