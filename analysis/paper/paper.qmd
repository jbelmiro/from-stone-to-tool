...
ggpubr::ggarrange(solutrean_stats_width, solutrean_stats_length, solutrean_stats_weight, labels = c("a", "b", "c"), heights = c(5, 5, 5), ncol = 1, common.legend = TRUE, legend = "bottom")
...
ggpubr::ggarrange(proto_stats_width, proto_stats_length, proto_stats_weight, labels = c("a", "b", "c"), heights = c(5, 5, 5), ncol = 1, common.legend = TRUE, legend = "bottom")
...
ggpubr::ggarrange(gravettian_stats_width, gravettian_stats_length, gravettian_stats_weight, labels = c("a", "b", "c"), heights = c(5, 5, 5), ncol = 1, common.legend = TRUE, legend = "bottom")
...
```{r}
#| label: fig-ratiotd
#| fig-cap: Plotted ratios of tools-to-debitage by chert types (x axis) and assemblage (colour). Distance to source groups (local and non-local) are marked by different shapes.
...
ratio_tooldebitage %>%
  ...
  mutate(RMTYPE = factor(RMTYPE, levels = c("TYPE 1","TYPE 2", "TYPE 3", "TYPE 4",
                                        "TYPE 5", "TYPE 6","TYPE 7", 
                                        "TYPE 8", "TYPE 9", "TYPE 10", "TYPE 11", "TL"))) %>%
  ggplot(aes(x=RMTYPE, y=`Tool/Blank`, shape = Source, colour = Assemblage)) +
  geom_point(size=2)
